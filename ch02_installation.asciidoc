...
$ conda create -n _<Name-of-virtual-environment>_ python=<version>　# Create virtual environment. 
$ conda info -e  # Display virtual environment list created 
$ conda remove -n _<environment-name>_ # Virtual environment deletion 
$ source activate _<environment-name>_ # Using virtual environment (mac / linux) 
$ activate _<environment-name>_ # 仮想環境を使う(Windows)
